...
void MOD_module_exec::init_symbols_0()
{
  ...
  init_symbol(&symbols[1u], "exec", SYM_PORT, &PORT_exec, 89u);
  init_symbol(&symbols[2u], "exec_csrVal", SYM_PORT, &PORT_exec_csrVal, 32u);
  init_symbol(&symbols[3u], "exec_dInst", SYM_PORT, &PORT_exec_dInst, 75u);
				  ...
				  tUInt32 ARG_exec_csrVal)
{
  ...
  PORT_exec_csrVal = ARG_exec_csrVal;
...
unsigned int MOD_module_exec::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "exec_csrVal", 32u);
...
void MOD_module_exec::vcd_defs(tVCDDumpType dt, MOD_module_exec &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.PORT_exec = PORT_exec;
      ...
      ++num;
      if ((backing.PORT_exec_csrVal) != PORT_exec_csrVal)
      {
	vcd_write_val(sim_hdl, num, PORT_exec_csrVal, 32u);
	backing.PORT_exec_csrVal = PORT_exec_csrVal;
      }
      ++num;
