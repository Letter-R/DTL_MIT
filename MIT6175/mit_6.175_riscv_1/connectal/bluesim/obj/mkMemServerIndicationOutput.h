...
class MOD_mkMemServerIndicationOutput : public Module {
 ...
 public:
  ...
  tUInt8 PORT_EN_ifc_error;
  tUInt8 PORT_EN_portalIfc_indications_2_deq;
  tUInt8 PORT_EN_portalIfc_indications_3_deq;
  tUInt8 PORT_EN_ifc_reportMemoryTraffic;
  tUInt8 PORT_EN_ifc_reportStateDbg;
  tUInt8 PORT_EN_ifc_addrResponse;
  tUInt32 PORT_portalIfc_messageSize_size_methodNumber;
  tUInt32 PORT_ifc_error_code;
  tUInt32 PORT_ifc_error_sglId;
  tUInt64 PORT_ifc_error_offset;
  tUInt64 PORT_ifc_error_extra;
  tUInt64 PORT_ifc_reportMemoryTraffic_words;
  tUWide PORT_ifc_reportStateDbg_rec;
  tUInt64 PORT_ifc_addrResponse_physAddr;
 ...
 public:
  ...
  tUInt8 DEF_WILL_FIRE_ifc_error;
  ...
  tUInt8 DEF_WILL_FIRE_ifc_reportMemoryTraffic;
  tUInt8 DEF_WILL_FIRE_ifc_reportStateDbg;
  tUInt8 DEF_WILL_FIRE_ifc_addrResponse;
