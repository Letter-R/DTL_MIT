...
void MOD_mkRFile::init_symbols_0()
{
  ...
  init_symbol(&symbols[2u], "CAN_FIRE_wr", SYM_DEF, &DEF_CAN_FIRE_wr, 1u);
  init_symbol(&symbols[3u], "EN_wr", SYM_PORT, &PORT_EN_wr, 1u);
  init_symbol(&symbols[4u], "RDY_rd1", SYM_PORT, &PORT_RDY_rd1, 1u);
  init_symbol(&symbols[5u], "RDY_rd2", SYM_PORT, &PORT_RDY_rd2, 1u);
  init_symbol(&symbols[6u], "RDY_wr", SYM_PORT, &PORT_RDY_wr, 1u);
  init_symbol(&symbols[7u], "rd1", SYM_PORT, &PORT_rd1, 32u);
  init_symbol(&symbols[8u], "rd1_rindx", SYM_PORT, &PORT_rd1_rindx, 5u);
  init_symbol(&symbols[9u], "rd2", SYM_PORT, &PORT_rd2, 32u);
  init_symbol(&symbols[10u], "rd2_rindx", SYM_PORT, &PORT_rd2_rindx, 5u);
  init_symbol(&symbols[11u], "rfile_0", SYM_MODULE, &INST_rfile_0);
  init_symbol(&symbols[12u], "rfile_1", SYM_MODULE, &INST_rfile_1);
  init_symbol(&symbols[13u], "rfile_10", SYM_MODULE, &INST_rfile_10);
  init_symbol(&symbols[14u], "rfile_11", SYM_MODULE, &INST_rfile_11);
  init_symbol(&symbols[15u], "rfile_12", SYM_MODULE, &INST_rfile_12);
  init_symbol(&symbols[16u], "rfile_13", SYM_MODULE, &INST_rfile_13);
  init_symbol(&symbols[17u], "rfile_14", SYM_MODULE, &INST_rfile_14);
  init_symbol(&symbols[18u], "rfile_15", SYM_MODULE, &INST_rfile_15);
  init_symbol(&symbols[19u], "rfile_16", SYM_MODULE, &INST_rfile_16);
  init_symbol(&symbols[20u], "rfile_17", SYM_MODULE, &INST_rfile_17);
  init_symbol(&symbols[21u], "rfile_18", SYM_MODULE, &INST_rfile_18);
  init_symbol(&symbols[22u], "rfile_19", SYM_MODULE, &INST_rfile_19);
  init_symbol(&symbols[23u], "rfile_2", SYM_MODULE, &INST_rfile_2);
  init_symbol(&symbols[24u], "rfile_20", SYM_MODULE, &INST_rfile_20);
  init_symbol(&symbols[25u], "rfile_21", SYM_MODULE, &INST_rfile_21);
  init_symbol(&symbols[26u], "rfile_22", SYM_MODULE, &INST_rfile_22);
  init_symbol(&symbols[27u], "rfile_23", SYM_MODULE, &INST_rfile_23);
  init_symbol(&symbols[28u], "rfile_24", SYM_MODULE, &INST_rfile_24);
  init_symbol(&symbols[29u], "rfile_25", SYM_MODULE, &INST_rfile_25);
  init_symbol(&symbols[30u], "rfile_26", SYM_MODULE, &INST_rfile_26);
  init_symbol(&symbols[31u], "rfile_27", SYM_MODULE, &INST_rfile_27);
  init_symbol(&symbols[32u], "rfile_28", SYM_MODULE, &INST_rfile_28);
  init_symbol(&symbols[33u], "rfile_29", SYM_MODULE, &INST_rfile_29);
  init_symbol(&symbols[34u], "rfile_3", SYM_MODULE, &INST_rfile_3);
  init_symbol(&symbols[35u], "rfile_30", SYM_MODULE, &INST_rfile_30);
  init_symbol(&symbols[36u], "rfile_31", SYM_MODULE, &INST_rfile_31);
  init_symbol(&symbols[37u], "rfile_4", SYM_MODULE, &INST_rfile_4);
  init_symbol(&symbols[38u], "rfile_5", SYM_MODULE, &INST_rfile_5);
  init_symbol(&symbols[39u], "rfile_6", SYM_MODULE, &INST_rfile_6);
  init_symbol(&symbols[40u], "rfile_7", SYM_MODULE, &INST_rfile_7);
  init_symbol(&symbols[41u], "rfile_8", SYM_MODULE, &INST_rfile_8);
  init_symbol(&symbols[42u], "rfile_9", SYM_MODULE, &INST_rfile_9);
  init_symbol(&symbols[43u], "WILL_FIRE_wr", SYM_DEF, &DEF_WILL_FIRE_wr, 1u);
  init_symbol(&symbols[44u], "wr_data", SYM_PORT, &PORT_wr_data, 32u);
  init_symbol(&symbols[45u], "wr_rindx", SYM_PORT, &PORT_wr_rindx, 5u);
}
