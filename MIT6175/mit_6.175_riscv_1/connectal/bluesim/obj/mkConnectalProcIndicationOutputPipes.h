...
class MOD_mkConnectalProcIndicationOutputPipes : public Module {
 ...
 public:
  ...
  tUInt8 PORT_EN_methods_sendMessage_enq;
  tUInt8 PORT_EN_methods_wroteWord_enq;
  tUInt32 PORT_portalIfc_messageSize_size_methodNumber;
  tUInt32 PORT_methods_sendMessage_enq_v;
  tUInt32 PORT_methods_wroteWord_enq_v;
 ...
 public:
  ...
  tUInt8 DEF_WILL_FIRE_methods_wroteWord_enq;
  tUInt8 DEF_WILL_FIRE_methods_sendMessage_enq;
