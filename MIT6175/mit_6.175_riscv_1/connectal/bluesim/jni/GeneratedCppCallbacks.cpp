...
int ConnectalProcRequestsoftReset_cb (  struct PortalInternal *p ) {
    (static_cast<ConnectalProcRequestWrapper *>(p->parent))->softReset ( );
    return 0;
};
ConnectalProcRequestCb ConnectalProcRequest_cbTable = {
    ConnectalProcRequestdisconnect_cb,
    ConnectalProcRequesthostToCpu_cb,
    ConnectalProcRequestsoftReset_cb,
};
