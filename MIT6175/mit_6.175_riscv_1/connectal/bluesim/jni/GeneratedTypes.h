...
enum { CHAN_NUM_ConnectalProcRequest_hostToCpu,CHAN_NUM_ConnectalProcRequest_softReset};
...
} ConnectalProcRequest_softResetData;
typedef union {
    ConnectalProcRequest_hostToCpuData hostToCpu;
    ConnectalProcRequest_softResetData softReset;
...
typedef struct {
    ...
    int (*softReset) (  struct PortalInternal *p );
...
int ConnectalProcRequestJson_softReset ( struct PortalInternal *p );
